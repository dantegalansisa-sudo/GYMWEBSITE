...
import { MapPin, Phone, Instagram, Clock, MessageCircle, ExternalLink } from "lucide-react";
          ...
          <ScrollReveal direction="left">
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="mb-1 font-[family-name:var(--font-oswald)] text-sm font-bold uppercase tracking-wider text-roca-black">Dirección</h4>
                  <p className="text-sm text-roca-gray">Km 13, Autopista Duarte, Los Ángeles, Santo Domingo, RD</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-roca-orange-light">
                ...
                <div>
                  <h4 className="mb-1 font-[family-name:var(--font-oswald)] text-sm font-bold uppercase tracking-wider text-roca-black">Teléfonos</h4>
                  <p className="text-sm text-roca-gray">
                    <a href="tel:+18098205103" className="transition-colors hover:text-roca-orange">809-820-5103</a> |{" "}
                    <a href="tel:+18295544752" className="transition-colors hover:text-roca-orange">829-554-4752</a>
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="mb-1 font-[family-name:var(--font-oswald)] text-sm font-bold uppercase tracking-wider text-roca-black">Instagram</h4>
                  <a href="https://instagram.com/rocagimnasio13" target="_blank" rel="noopener noreferrer"
                    className="text-sm text-roca-gray transition-colors hover:text-roca-orange">@rocagimnasio13</a>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-roca-orange-light">
                ...
                <div>
                  <h4 className="mb-1 font-[family-name:var(--font-oswald)] text-sm font-bold uppercase tracking-wider text-roca-black">Horarios</h4>
              ...
              <a href="https://wa.me/18098205103?text=Hola%20Roca%20Gimnasio,%20quiero%20información"
              ...
              ><MessageCircle className="h-5 w-5" /> WhatsApp: 809-820-5103</a>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal direction="right">
            <div className="overflow-hidden rounded-2xl border border-roca-gray-border">
              <iframe
                ...
                referrerPolicy="no-referrer-when-downgrade" title="Ubicación Roca Gimnasio"
              />
              <a href="https://maps.google.com/?q=Km+13+Autopista+Duarte+Santo+Domingo"
                target="_blank" rel="noopener noreferrer"
              ...
              ><ExternalLink className="h-4 w-4" /> Abrir en Google Maps</a>
            </div>
          </ScrollReveal>
        </div>
      </div>
