...
export default function CEOSection() {
  return (
    <section className="bg-roca-cream py-28 lg:py-36">
          ...
          <ScrollReveal direction="left">
            <div>
              ...
              <p className="mb-8 text-lg leading-relaxed text-roca-gray">
                ...
                miembro de ROCA reciba atención personalizada.
              </p>
              <p className="mb-10 font-[family-name:var(--font-oswald)] text-sm italic tracking-wider text-roca-gray-dark">
                Fundador &amp; Coach Principal
              </p>
              <div className="relative rounded-2xl border border-roca-orange/20 bg-white p-8">
          ...
          <ScrollReveal direction="right">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 flex items-center gap-3 rounded-xl bg-white px-5 py-3 shadow-lg lg:-left-8">
                ...
                <div>
                  <p className="font-[family-name:var(--font-oswald)] text-lg font-bold text-roca-black">
                    10+
                  </p>
                  <p className="text-xs text-roca-gray">
                    Años de Experiencia
                  </p>
                </div>
              </div>
